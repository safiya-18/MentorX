    ...
    <div className="min-h-screen bg-slate-50 relative flex items-center justify-center p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-1">Join MentorX to supercharge your productivity</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-slate-600">
          Already have an account? <Link to="/login" className="text-mentorBlue-600 font-medium hover:underline">Log In</Link>
        </p>
      </motion.div>
    </div>
  );
