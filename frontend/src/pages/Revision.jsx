...
const Revision = () => {
  ...
  const generateNotes = async (topicToGenerate) => {
    let finalTopic = typeof topicToGenerate === 'string' ? topicToGenerate : '';
    if (!finalTopic) {
...
- Never fabricate formulas.`;
  ...
  useEffect(() => {
    if (urlTopic && !hasAutoGenerated) {
      setTimeout(() => {
        setIsCustomMode(true);
        setCustomTopic(urlTopic);
        setHasAutoGenerated(true);
        generateNotes(urlTopic);
      }, 0);
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [urlTopic, hasAutoGenerated]);
